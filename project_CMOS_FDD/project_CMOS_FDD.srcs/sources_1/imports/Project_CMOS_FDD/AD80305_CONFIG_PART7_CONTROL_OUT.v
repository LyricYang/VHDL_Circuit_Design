/************************************************************
module name 	: AD80305_CONFIG_PART7_CONTROL_OUT
project			: AD936x FPGA
version			: 0.1
author			: ShangHai HanRu
called by		: 
calling			:
description		: Setup Control Outs
...
begin
    ...
    case ( Current_state )
		...
		CONFIG_DATA:
			if ( ( Config_done_1byte == 1'b1 ) && ( Config_addr_1byte == 10'h036 ) ) 
...
begin
	if ( Reset == 1'b1 )
		...
		Config_addr_1byte <= 10'h035; 
	else if ( ( Current_state == CONFIG_DATA ) && ( Config_done_1byte == 1'b1 ) )
		case ( Config_addr_1byte )
			10'h035: Config_addr_1byte <= 10'h036;	
			default: Config_addr_1byte <= 10'h035;
		endcase
	else
		;
end	
...
begin
	if ( Reset == 1'b1 )
		...
		case ( Config_addr_1byte )
			10'h035: Config_data_wr_1byte <= 8'h01;
			10'h036: Config_data_wr_1byte <= 8'hFF;		  	
