/************************************************************
module name 	: AD80305_CONFIG_PART22_END_ENABLE_RX_TX
project			: AD936x FPGA
version			: 0.1
author			: ShangHai HanRu
called by		: 
calling			:
description		: Enable RX channel and TX channel
...
begin
    ...
    case ( Current_state )
		...
		CONFIG_DATA:
			if ( ( Config_done_1byte == 1'b1 ) && ( Config_addr_1byte == 10'h003 ) ) 
...
begin
	if ( Reset == 1'b1 )
		...
		case ( Config_addr_1byte )
//			10'h002: Config_data_wr_1byte <= 8'h4E;		// Set 1 transmitters enabled  
//			10'h003: Config_data_wr_1byte <= 8'h5E;		// Set 1 receivers enabled      	
//		  	default: Config_data_wr_1byte <= 8'h4E;
			10'h002: Config_data_wr_1byte <= 8'h8E;		// Set 2 transmitters enabled  
			10'h003: Config_data_wr_1byte <= 8'h9E;		// Set 2 receivers enabled      	
		  	default: Config_data_wr_1byte <= 8'h8E;	
		endcase
	else
		Config_data_wr_1byte <= 8'b0;
end
