...
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[1] }]; #IO_L16N_T2_A27_15 Sch=fmc_la_n[02]
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[0] }]; #IO_L16P_T2_A28_15 Sch=fmc_la_p[02]
set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[3] }]; #IO_L17N_T2_A25_15 Sch=fmc_la_n[03]
set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[2] }]; #IO_L17P_T2_A26_15 Sch=fmc_la_p[03]
set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[5] }]; #IO_L18N_T2_A23_15 Sch=fmc_la_n[04]
set_property -dict { PACKAGE_PIN N20   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[4] }]; #IO_L18P_T2_A24_15 Sch=fmc_la_p[04]
set_property -dict { PACKAGE_PIN L21   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[7] }]; #IO_L10N_T1_AD11N_15 Sch=fmc_la_n[05]
set_property -dict { PACKAGE_PIN M21   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[6] }]; #IO_L10P_T1_AD11P_15 Sch=fmc_la_p[05]
set_property -dict { PACKAGE_PIN M22   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[9] }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=fmc_la_n[06]
set_property -dict { PACKAGE_PIN N22   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[8] }]; #IO_L15P_T2_DQS_15 Sch=fmc_la_p[06]
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[11] }]; #IO_L20N_T3_A19_15 Sch=fmc_la_n[07]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p0_d[10] }]; #IO_L20P_T3_A20_15 Sch=fmc_la_p[07]
...
set_property -dict { PACKAGE_PIN K22   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[7] }]; #IO_L9N_T1_DQS_AD3N_15 Sch=fmc_la_n[10]
set_property -dict { PACKAGE_PIN K21   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[6] }]; #IO_L9P_T1_DQS_AD3P_15 Sch=fmc_la_p[10]
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[1] }]; #IO_L22N_T3_A16_15 Sch=fmc_la_n[11]
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[0] }]; #IO_L22P_T3_A17_15 Sch=fmc_la_p[11]
set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[3] }]; #IO_L14N_T2_SRCC_15 Sch=fmc_la_n[12]
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[2] }]; #IO_L14P_T2_SRCC_15 Sch=fmc_la_p[12]
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[5] }]; #IO_L21N_T3_DQS_A18_15 Sch=fmc_la_n[13]
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[4] }]; #IO_L21P_T3_DQS_15 Sch=fmc_la_p[13]
set_property -dict { PACKAGE_PIN H22   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[9] }]; #IO_L7N_T1_AD2N_15 Sch=fmc_la_n[14]
set_property -dict { PACKAGE_PIN J22   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[8] }]; #IO_L7P_T1_AD2P_15 Sch=fmc_la_p[14]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[11] }]; #IO_L23N_T3_FWE_B_15 Sch=fmc_la_n[15]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS25 } [get_ports { Ad80305_p1_d[10] }]; #IO_L23P_T3_FOE_B_15 Sch=fmc_la_p[15]
