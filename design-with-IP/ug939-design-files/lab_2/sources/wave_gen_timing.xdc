...
set_multicycle_path -from [get_cells {cmd_parse_i0/send_resp_data*} -filter {is_sequential}] -to [get_cells {resp_gen_i0/to_bcd_i0/bcd_out[*]}] 2
set_multicycle_path -hold -from [get_cells {cmd_parse_i0/send_resp_data*} -filter {is_sequential}] -to [get_cells {resp_gen_i0/to_bcd_i0/bcd_out[*]}] 1
...
set_max_delay -from [get_cells clkx_nsamp_i0/meta_harden_bus_new_i0/signal_meta] -to [get_cells clkx_nsamp_i0/meta_harden_bus_new_i0/signal_dst] 2.000
set_max_delay -from [get_cells clkx_pre_i0/meta_harden_bus_new_i0/signal_meta] -to [get_cells clkx_pre_i0/meta_harden_bus_new_i0/signal_dst] 2.000
set_max_delay -from [get_cells clkx_spd_i0/meta_harden_bus_new_i0/signal_meta] -to [get_cells clkx_spd_i0/meta_harden_bus_new_i0/signal_dst] 2.000
set_max_delay -from [get_cells lb_ctl_i0/debouncer_i0/meta_harden_signal_in_i0/signal_meta] -to [get_cells lb_ctl_i0/debouncer_i0/meta_harden_signal_in_i0/signal_dst] 2.000
set_max_delay -from [get_cells samp_gen_i0/meta_harden_samp_gen_go_i0/signal_meta] -to [get_cells samp_gen_i0/meta_harden_samp_gen_go_i0/signal_dst] 2.000
set_max_delay -from [get_cells uart_rx_i0/meta_harden_rxd_i0/signal_meta] -to [get_cells uart_rx_i0/meta_harden_rxd_i0/signal_dst] 2.000
set_max_delay -from [get_cells rst_gen_i0/reset_bridge_clk_rx_i0/rst_meta] -to [get_cells rst_gen_i0/reset_bridge_clk_rx_i0/rst_dst] 2.000
set_max_delay -from [get_cells rst_gen_i0/reset_bridge_clk_tx_i0/rst_meta] -to [get_cells rst_gen_i0/reset_bridge_clk_tx_i0/rst_dst] 2.000
set_max_delay -from [get_cells rst_gen_i0/reset_bridge_clk_samp_i0/rst_meta] -to [get_cells rst_gen_i0/reset_bridge_clk_samp_i0/rst_dst] 2.000
