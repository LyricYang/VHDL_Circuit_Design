...
if {[file isfile MatrixMultiply.autotvin.dat]} {
	file delete -force MatrixMultiply.autotvin.dat
}

if {[file isfile MatrixMultiply.autotvout.dat]} {
	file delete -force MatrixMultiply.autotvout.dat
}
