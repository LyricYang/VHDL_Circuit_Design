...
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2017.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2017.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2017.1/win64/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2017.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2017.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "MatrixMultiply.autotvin.dat"
	set constFileTvOut       "MatrixMultiply.autotvout.dat"
	set constFileHdlTvIn     "MatrixMultiply.autohdltvin.dat"
	set constFileHdlTvOut    "MatrixMultiply.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
