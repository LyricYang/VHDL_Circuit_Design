...
#ifndef __MatrixMultiply_mubkb__HH__
#define __MatrixMultiply_mubkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MatrixMultiply_mubkb) {
    ...
    SC_CTOR(MatrixMultiply_mubkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
