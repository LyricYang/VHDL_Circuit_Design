...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i32 bitcast (i32 (...)* @MatrixMultiply to i32 (i32*, i32*, i32*)*)(i32* getelementptr inbounds ([25 x i32]* @MatrixA, i32 0, i32 0), i32* getelementptr inbounds ([5 x i32]* @Vector_b, i32 0, i32 0), i32* getelementptr inbounds ([5 x i32]* @HLS_Result_c, i32 0, i32 0)) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1_count);
   /*tail*/ MatrixMultiply((signed int *)((&MatrixA[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 25
#endif
...
printf("\n  %%1 = load i32* %%matlab_result, align 4, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_14_count);
  llvm_cbe_tmp__2 = (unsigned int )*llvm_cbe_matlab_result;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = load i32* %%your_result, align 4, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_15_count);
  llvm_cbe_tmp__3 = (unsigned int )*llvm_cbe_your_result;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%5 = getelementptr inbounds i32* %%matlab_result, i32 1, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__6 = (signed int *)(&llvm_cbe_matlab_result[(((signed int )1u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%7 = getelementptr inbounds i32* %%your_result, i32 1, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_26_count);
  llvm_cbe_tmp__8 = (signed int *)(&llvm_cbe_your_result[(((signed int )1u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%11 = getelementptr inbounds i32* %%matlab_result, i32 2, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_36_count);
  llvm_cbe_tmp__12 = (signed int *)(&llvm_cbe_matlab_result[(((signed int )2u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%13 = getelementptr inbounds i32* %%your_result, i32 2, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_38_count);
  llvm_cbe_tmp__14 = (signed int *)(&llvm_cbe_your_result[(((signed int )2u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%15 = sub nsw i32 %%12, %%14, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_40_count);
  llvm_cbe_tmp__16 = (unsigned int )((unsigned int )(llvm_cbe_tmp__13&4294967295ull)) - ((unsigned int )(llvm_cbe_tmp__15&4294967295ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%17 = getelementptr inbounds i32* %%matlab_result, i32 3, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_48_count);
  llvm_cbe_tmp__18 = (signed int *)(&llvm_cbe_matlab_result[(((signed int )3u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%19 = getelementptr inbounds i32* %%your_result, i32 3, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_50_count);
  llvm_cbe_tmp__20 = (signed int *)(&llvm_cbe_your_result[(((signed int )3u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%21 = sub nsw i32 %%18, %%20, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_52_count);
  llvm_cbe_tmp__22 = (unsigned int )((unsigned int )(llvm_cbe_tmp__19&4294967295ull)) - ((unsigned int )(llvm_cbe_tmp__21&4294967295ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%23 = getelementptr inbounds i32* %%matlab_result, i32 4, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_60_count);
  llvm_cbe_tmp__24 = (signed int *)(&llvm_cbe_matlab_result[(((signed int )4u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%25 = getelementptr inbounds i32* %%your_result, i32 4, !dbg !4 for 0x%I64xth hint within @CheckResult  --> \n", ++aesl_llvm_cbe_62_count);
  llvm_cbe_tmp__26 = (signed int *)(&llvm_cbe_your_result[(((signed int )4u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
